...
$(function(){
    ...
    $link.on('click', function () {
        ...
        $('html, body').animate({
            scrollTop: $(id).offset().top - menuBar.height() - 10
        }, 1500);
...
/*var map;
    function initMap() {
        map = new google.maps.Map(document.getElementById('pintangueisMap'), {
            center: {lat: -34.397, lng: 150.644},
            zoom: 8
        });
    }*/

//AIzaSyDGFVBXw2rbTZ-1w0zdX3fZFWuFEdBIpqs
$(document).ready(function() {
  var bigimage = $("#sliderLazer");
  var thumbs = $("#listLazer");
  //var totalslides = 10;
